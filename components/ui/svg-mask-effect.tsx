...
export const MaskContainer = ({
  ...
  return (
    <motion.div
      ...
      animate={{
        backgroundColor: isHovered ? "bg-foreground/80" : "",
      }}
    >
      <motion.div
        className="w-full h-full flex items-center justify-center text-6xl absolute [mask-image:url(/svg/mask.svg)] [mask-size:40px] [mask-repeat:no-repeat]"
        animate={{
